...
java --add-opens=java.base/java.nio=ALL-UNNAMED -cp $LIB_DIR/octopus-server-1.0.0-beta.1-SNAPSHOT-jar-with-dependencies.jar com.sony.SparkFlightServer --host $ARROW_FLIGHT_HOST --port ${PORT_NUM} >> ${LOG_FILE}